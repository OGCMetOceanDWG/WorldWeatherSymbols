...
case $1 in
    ...
    echo "# WorldWeatherSymbols Symbols" > $ROOT_SYMBOLS_README
    for svg_dir in $SVG_DIRS
    do
      echo "Creating $README"
      DIRECTORY_NAME=`basename $svg_dir`
      README=$svg_dir/README.md
      echo "* [$DIRECTORY_NAME](https://github.com/OGCMetOceanDWG/WorldWeatherSymbols/blob/master/symbols/$DIRECTORY_NAME)" >> $ROOT_SYMBOLS_README
      ...
      do
        ...
        echo " * $SVG_FILENAME: ![$SVG_FILENAME2](https://cdn.rawgit.com/OGCMetOceanDWG/WorldWeatherSymbols/master/$SVG_DIR_FILE2)" >> $ROOT_SYMBOLS_README
      done
